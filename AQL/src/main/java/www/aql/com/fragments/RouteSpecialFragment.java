...
import www.aql.com.activities.routespecialmore.RouteSpecialMoreActivity;
 ...
 */
public class RouteSpecialFragment extends Fragment {

    @BindView(R.id.webView)
    WebView webView;
    private String url;

    public static RouteSpecialFragment getInstance(String url) {
        RouteSpecialFragment fragment = new RouteSpecialFragment();
    ...
    public void onClick() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(Keys.WEBVIEW_URL, url);
        ActivitySkipHelper.skipToActivityWithData(getActivity(), RouteSpecialMoreActivity.class, bundle);
    }
}
