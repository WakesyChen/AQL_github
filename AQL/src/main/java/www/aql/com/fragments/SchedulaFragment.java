...
import www.aql.com.activities.schedulamore.SchedulaMoreActivity;
 ...
 */
public class SchedulaFragment extends Fragment {

    @BindView(R.id.webView)
    WebView webView;
    private String url;

    public static SchedulaFragment getInstance(String url) {
        SchedulaFragment fragment = new SchedulaFragment();
    ...
    public void onClick() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(Keys.WEBVIEW_URL, url);
        ActivitySkipHelper.skipToActivityWithData(getActivity(), SchedulaMoreActivity.class, bundle);
    }
