 ...
 */
public class AroundPresenter implements AroundContact.IAroundPresenter {
    private AroundContact.IAroundView view;

    public AroundPresenter(AroundContact.IAroundView view) {
        this.view = view;
    }
