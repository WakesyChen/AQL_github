 ...
 */
public class InternaltionalPresenter implements InternaltionalContact.IInternaltionalPresenter {
    private InternaltionalContact.IInternaltionalView view;

    public InternaltionalPresenter(InternaltionalContact.IInternaltionalView view) {
        this.view = view;
    }
