...
public class InnerCountryActivity extends BaseActivity implements InnerCountryContact.IInnerCountryView {
    ...
    private InnerCountryPresenter presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inner_country);
        ButterKnife.bind(this);

        presenter = new InnerCountryPresenter(this);
    ...
    private class MyOnScrollListener implements AbsListView.OnScrollListener {
        ...
        public void onScroll(AbsListView view, int firstVisibleItem,
            ...
            if (scrollFlag && ScreenUtils.getScreenViewBottomHeight(lv) >= ScreenUtils
                    .getScreenHeight(InnerCountryActivity.this) / 20) {
            }
