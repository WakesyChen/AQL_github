...
public class RouteDetailActivity extends BaseFragmentActivity implements RouteDetailContact.IRouteDetailView {
    ...
    private Route route;
    private RouteDetailContact.IRouteDetailPresenter presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter = new RouteDetailPresenter(this);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.tv_visaInfo:
                ...
                ActivitySkipHelper.skipToActivityWithData(RouteDetailActivity.this, VisaActivity.class, bundle);
                break;
            case R.id.tv_reserveInfo:
                //跳转到预订须知
                bundle.putString(Keys.WEBVIEW_URL, route.urlinfo.reserveinfourl);
                ActivitySkipHelper.skipToActivityWithData(RouteDetailActivity.this, ReserveActivity.class, bundle);
                break;
            case R.id.tv_kefu:
                break;
            ...
            case R.id.tv_prebuy_now:
                ...
                if (userid.equals("")) {
                    ...
                    ActivitySkipHelper.skipToActivityForResultWithData(RouteDetailActivity.this, LoginActivity.class,
                ...
                break;
            case R.id.img_share:
                Intent intent = new Intent(RouteDetailActivity.this, ShareDialogActivity.class);
